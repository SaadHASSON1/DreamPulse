        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (isActive) {
                    ...
                    val serviceIntent = Intent(context, com.x13labs.dreampulse.service.SleepMonitorService::class.java).apply {
                        putExtra(com.x13labs.dreampulse.service.SleepMonitorService.EXTRA_SLEEP_DURATION, duration * 60 * 1000L)
                    }
                    try {
